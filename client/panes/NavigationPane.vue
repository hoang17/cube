<template lang="pug">
  div
    v-text-field(label='Label', v-model='cube.content')
    ...
    //- v-text-field(label='Border', v-model='cube.style.border')
    //- v-text-field(label='Border Radius', v-model='cube.style.borderRadius')
