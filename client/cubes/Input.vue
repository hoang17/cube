<template lang="pug">
  .cube.textfield(:edit="edit", :active="active", :style="cube.style | styl", @click.stop="edit && focus()", :class="cube.css|css", @mouseover.stop="")
    .flex.xs5
      label.label(:for="cube._id") {{ cube.content }}
    .flex.xs7
      input.input(:id="cube._id", :placeholder="cube.placeholder")
</template>
